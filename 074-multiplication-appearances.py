"""
Daily Coding Problem - 2018-12-21.
...
def appearances(size, target):
    """How many times does the target appear in the multiplication table."""
    appears = 0
...
print(appearances(6, 12))    # 4
print(appearances(6, 6))    # 4
