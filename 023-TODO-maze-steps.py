"""
Daily Coding Problem - 2018-10-30.
...
def maze_steps(arr, start, end):
    """Return number of steps needed to get from start to end coord."""
    pass
...
maze = [['f', 'f', 'f', 'f'],
        ...
        ['f', 'f', 'f', 'f'],
        ['f', 'f', 'f', 'f']]
print(maze_steps(maze, [3, 0], [0, 0]))    # 7
